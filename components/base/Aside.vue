    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#configuracion" class="nav-link" aria-controls="configuracion"
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#compras" class="nav-link" aria-controls="compras" role="button"
                        aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#ventas" class="nav-link" aria-controls="ventas" role="button"
                        aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                        ...
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item">
                                <nuxtLink class="nav-link" to="/ventas/lista">
                                    ...
                                    <span class="sidenav-normal"> Venta </span>
                                </nuxtLink>
                            </li>
                        </ul>
                    </div>
