                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(m, i) in list">
                      ...
                      <td class="py-0 px-1">
                        <span class="badge " :class="[m.stock<m.stock_minimo?'badge-danger':'badge-success']"> {{m.stock}} {{ m.medida.codigo }}</span>
                      </td>

                      <td class="py-0 px-1">{{ Number(m.inversion).toFixed() }}</td>
                      <td class="py-0 px-1">{{ Number(m.valorizado).toFixed() }}</td>
                      <td class="py-0 px-1">{{ Number(m.ganancia).toFixed() }}</td>
