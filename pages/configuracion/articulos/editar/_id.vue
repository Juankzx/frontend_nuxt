                                ...
                                <CrudUpdate :model="model" :apiUrl="apiUrl">
                                    <div slot="body" class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" name="" v-model.number="model.stock_minimo"
                                                class="form-control" id="">
                                        </div>

                                        <div class="form-group col-6">
                                            <label for="">Precio Compra</label>
                                            <input type="text" name="" v-model.number="model.compra" class="form-control"
                                                id="">
                                        </div>

                                        <div class="form-group col-6">
                                            <label for="">Precio Venta</label>
                                            <input type="text" name="" v-model.number="model.venta" class="form-control"
                                                id="">
                                        </div>
